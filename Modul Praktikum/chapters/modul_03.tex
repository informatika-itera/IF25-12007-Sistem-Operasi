...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{lstlisting}[language=bash, caption={Mengubah hak akses berkas}]
    ...
    $ ls -l
        ...
        \item Coba ubah kepemilikan berkas tersebut menjadi milik pengguna \texttt{root}. Karena ini merupakan tindakan administratif, Anda memerlukan perintah \texttt{sudo} di awal baris.
