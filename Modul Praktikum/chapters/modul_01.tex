...
Tabel \ref{tab:m01-dasar-teori} merangkum hal-hal penting terkait teori di atas.

\begin{table}[h]
\caption{Tabel Ringkasan Dasar Teori}
\label{tab:m01-dasar-teori}
\centering
